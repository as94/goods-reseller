...
const saleBlocks = [
	{
		title: 'Что подарить?',
		body: 'Иногда сложно придумать, что подарить своему знакомому на его день. Наш новый проект HAPPYBOXY решает эту проблему. Мы предлагаем интересные подарочные комплекты. Все подарочные наборы составлялись мужчинами для мужчин, мы опрашивали многих молодых людей на предмет уместного подарка.',
		imagePath: 'url(assets/main-2.webp)',
	},
	{
		title: 'Классный подарочек',
		body: 'Подарок должен быть интересен, полезен и доступен. Он должен вызывать эмоции, улыбку, приятное удивление и восторг. Мужикам нравится, когда девушка обеспокоилась выбором подарка.',
		imagePath: null,
	},
	{
...
const infoBlocks = [
	{
		...
		body: 'Тем девушкам, которые устали думать о том, каким сюрпризом можно удивить своего любимого. Мы полностью уверены в том, что такой комплект устроит даже самого привередливого.',
		imagePath: 'url(assets/main-4.webp)',
	},
	{
		title: 'Наши гарантии',
		body: 'Что делать, если что-то пошло не по плану? Например, тебя не устроило содержимое комплекта при получении. Тогда мы полностью гарантируем полный возврат денег.',
		imagePath: 'url(assets/main-5.webp)',
	},
	{
		title: 'Оплата и доставка',
		body: 'Оплата при получении. Доставляем по всей Москве и Московской области. Цена доставки в пределах МКАД - 300 ₽. Доставка за МКАД обсуждается отдельно. Также отправляем Почтой России.',
		imagePath: null,
	},
]
