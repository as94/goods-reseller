...
const infoBlocks = [
	...
	},
	{
		...
		body: 'Оплата при получении. Отправляем Почтой России. Также доставляем по всей Москве и Московской области. Цена доставки в пределах МКАД - 300 ₽. Доставка за МКАД обсуждается отдельно.',
		imagePath: null,
	},
]
